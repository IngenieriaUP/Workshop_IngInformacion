...
app.layout = html.Div(children=[
    ...
    html.H1(children="Clarofónica", style={'text-align': 'center','font-family': 'Courgette', 'font-size':'80px','margin': '10px 0px 30px 0px', 'font-weight':'normal'}),

    html.Div([
        html.H3(children='Características', style={'font-size': '40px', 'margin': '0px 0px 30px 0px', 'font-family':'Open Sans','font-weight':'normal'}),
    ...
    html.Div([
        html.Div([
            html.Button('Consultar Cliente', id='button',
                        style={'clear': 'both', 'width': '100%', 'font-size': '20px', 'height':'40px', 'margin-top':'10px', 'border-radius':'20px', 'font-family':'Open Sans', 'margin':'20px 0px 0px 0px'}),
            html.H1(""),
            html.H4(children="La puntuación del cliente es de:",style={'text-align':'center','margin':'0px','font-family':'Open Sans','font-size':'30px','font-weight':'normal'}),

            html.Div(id='output-container-button', children='------', style={'font-size': '80px', 'text-align': 'center'}),
            html.Img(id='image',style={'width':'50%','display': 'block','margin-left':'auto','margin-right':'auto'})
        ], style={'width': '85%'}),
