...
app.layout = html.Div(children=[
    ...
    html.H1(children="Next's Survivor", style={'text-align': 'center','font-family': 'Courgette', 'font-size':'80px','padding-top':'10px'}),
    ...
    html.Div([
        ...
        html.Div([
            html.P(children='¿Qué edad tiene?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.Dropdown(
                options=[
        ...
        html.Div([
            html.P(children='¿Sabe de agricultura?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.RadioItems(
                options=[
                    {'label': 'Sí', 'value': '1'},
        ...
        html.Div([
            html.P(children='¿Sabe de ubicación?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.RadioItems(
                options=[
                    {'label': 'Sí', 'value': '1'},
        ...
        html.Div([
            html.P(children='¿Sabe de mecanica?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.RadioItems(
                options=[
                    {'label': 'Sí', 'value': '1'},
        ...
        html.Div([
            html.P(children='¿Sabe usar armas?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.RadioItems(
                options=[
                    {'label': 'Sí', 'value': '1'},
        ...
        html.Div([
            html.P(children='¿Sabe primeros auxilios?',
                   style={'float': 'left', 'width': '60%', 'max-width': '320px'}),
            dcc.RadioItems(
                options=[
                    {'label': 'Sí', 'value': '1'},
    ...
    html.Div([
        html.Div([
            ...
            html.H1(""),
            html.H4(children="La puntuación del sobreviviente es de:",style={'text-align': 'center','margin':'0px'}),
...
def update_output(n_clicks, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10):
    sumaProducto=-0.457+float(value1)*0.1735+float(value2)*-0.3614+float(value3)*0.8379+float(value4)*0.2526+float(value5)*-0.407+float(value6)*0.2809+float(value7)*0.2522+float(value8)*-0.1561+float(value9)*0.3443+float(value10)*-0.3728
